...
export default {
  ...
  data() {
    return {
      ...
      project: {
        title: "Chii",
        desc: "A Discord bot built while learning about the Discord.js module. Includes some moderation commands.",
        github: "https://github.com/brandonore/chii",
        siteUrl: "",
  ...
  methods: {
    showImgs() {
      this.imgs = [
        require("../assets/chii/report.png"),
        require("../assets/chii/anime.png"),
        require("../assets/chii/dog.png"),
        require("../assets/chii/players.png"),
      ];
      this.show();
    },
    show() {
...
<style scoped>
.img {
  background-image: url("../assets/chii/report.png");
