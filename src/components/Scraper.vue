...
export default {
  ...
  data() {
    return {
      ...
      project: {
        title: "Web Scraper",
        desc: "Node.js web scraper built during a learning course. Scrapes t-shirt data and exports to a .csv file.",
        github: "https://github.com/brandonore/Content-Scraper",
        siteUrl: "",
        tech: "Node - JS - Web Scraper",
      },
    };
  },
  methods: {
    showImgs() {
      this.imgs = [
        require("../assets/scraper/excel.png"),
        require("../assets/scraper/cmd.png"),
        require("../assets/scraper/exportcsv.png"),
      ];
      this.show();
    },
    show() {
...
<style scoped>
.img {
  background-image: url("../assets/scraper/excel.png");
